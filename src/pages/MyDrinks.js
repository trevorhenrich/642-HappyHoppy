...
export function MyDrinks(favDrinks) {
      ...
      <Box paddingTop={4} paddingBottom={4}>
        ...
        >
          <Grid item padding={2}>
            <Card>
              <CardActionArea
                onClick={() => navigate("/drinkprofile/1/Martini")}
              >
        ...
        >
          <Grid item padding={2}>
            <Card>
              <CardActionArea
                onClick={() => navigate("/drinkprofile/2/Gin and tonic")}
              >
                <Grid container direction="row" alignItems="left">
                  <img src="https://www.tasteofhome.com/wp-content/uploads/2018/03/Apple-Amaretto-Sours_EXPS_THCA18_188779_C01_23_3b.jpg?resize=100,100"></img>
                  <div classname="title" style={{ fontSize: "x-large" }}>
        ...
        >
          <Grid item padding={2}>
            <Card>
              <CardActionArea
                onClick={() => navigate("/drinkprofile/3/Margarita")}
              >
                <Grid container direction="row" alignItems="left">
                  <img src="https://www.tasteofhome.com/wp-content/uploads/2018/03/Apple-Amaretto-Sours_EXPS_THCA18_188779_C01_23_3b.jpg?resize=100,100"></img>
                  <div classname="title" style={{ fontSize: "x-large" }}>
        ...
        >
          <Grid item padding={2}>
            <Card>
              <CardActionArea
                onClick={() => navigate("/drinkprofile/4/Old Fashioned")}
              >
                <Grid container direction="row" alignItems="left">
                  <img src="https://www.tasteofhome.com/wp-content/uploads/2018/03/Apple-Amaretto-Sours_EXPS_THCA18_188779_C01_23_3b.jpg?resize=100,100"></img>
                  <div classname="title" style={{ fontSize: "x-large" }}>
